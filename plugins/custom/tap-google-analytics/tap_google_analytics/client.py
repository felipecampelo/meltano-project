...
from google.analytics.data_v1beta.types import (
    Filter, RunReportRequest, Metric, Dimension, FilterExpression, DateRange, FilterExpressionList
)
...
class GoogleAnalyticsStream(Stream):
    ...
    def _parse_response(self, response):
        if response:
            ...
            for row in response.rows:
                ...
                record["initial_date"] = self.config.get("start_date")
    ...
    def _query_api(
        ...
        #                         value="(?i)^([^o]|o(o|n(o|b(o|a(o|s(o|e(o|-(o|u(o|n(o|i(o|t(o|y(o|-(o|c(o|l(o|i(o|e(o|no)))))))))))))))))*"
        #                               "([^no]|n([^bo]|b([^ao]|a([^os]|s([^eo]|e([^o-]|-([^ou]|u([^no]|n([^io]|i([^ot]|t([^oy]|y([^o-]|-([^co]|c([^lo]|l([^io]|i([^eo]|e([^no]|n[^ot]))))))))))))))))))*(o(o|n(o|b(o|a(o|s(o|e(o|-(o|u(o|n(o|i(o|t(o|y(o|-(o|c(o|l(o|i(o|e(o|no)))))))))))))))))*(n((b(a(s(e(-(u(n(i(t(y(-(c(li?)?)?)?)?)?)?)?)?)?)?)?)?)?|base-unity-clien?))?)?$"
        #                         # reverse match on results containing the word "onbase-unity-client"
        #                     )
        #                 ),
        #             ),
        #         ]
        ...
        # start_date = str(date.today() - timedelta(days=30)) # 2021
    ...
    def schema(self) -> dict:
        ...
        properties.append(
            th.Property("initial_date", th.StringType(), required=True)
        )
        properties.append(
            th.Property("end_date", th.StringType(), required=True)
        )
        ...
        if not date_dimension_included:
            ...
            primary_keys.append("initial_date")
            primary_keys.append("end_date")
